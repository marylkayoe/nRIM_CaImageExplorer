...
if isempty(roiList)
    ...
    if ~isempty(stimTimes)
        ...
        plotMeanTriggeredWindows(triggeredPerStimWindows, preWin, stimDuration, framerate, 'Stim-triggered means per stim', 'axesHandle', gca, 'figHandle', figHandle, 'legendText', 'ROI');
